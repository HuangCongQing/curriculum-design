...
int show_bmp_not_800_480(char * bmp_path,int x,int y,int z){
	...
	//unsigned int buff_lcd[LCD_W * LCD_H] = {0};
		switch(z){
			case 0:{
				proc_bmp_not_800_480("0.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 1:{
				proc_bmp_not_800_480("1.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 2:{
				proc_bmp_not_800_480("2.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 3:{
				proc_bmp_not_800_480("3.bmp",buff_lcd,x,y);//刷入小图信息
				break;	
			}
			case 4:{
				proc_bmp_not_800_480("4.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 5:{
				proc_bmp_not_800_480("5.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 6:{
				proc_bmp_not_800_480("6.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 7:{
				proc_bmp_not_800_480("7.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 8:{
				proc_bmp_not_800_480("8.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
			case 9:{
				proc_bmp_not_800_480("9.bmp",buff_lcd,x,y);//刷入小图信息
				break;
			}
		}
