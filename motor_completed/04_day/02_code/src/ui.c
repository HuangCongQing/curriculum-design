...
int pro_ui_dht(){
	// printf("pro_ui_dht:----\n");
	bmp_800_480("./em.bmp");
	show_arg_cir(400,150,exp_quan/10%10);
	show_arg_cir(450,150,exp_quan%10);
	show_arg_cir(150,220,exp_speed/1000%10);
	show_arg_cir(200,220,exp_speed/100%10);
	show_arg_cir(250,220,exp_speed/10%10);
	show_arg_cir(300,220,exp_speed%10);
	while(ui_flag ==  UI_DHT){
		switch(dht_opt){
			...
			case DHT_CONTROL_DI:{
				...
				show_arg_cir(250,220,exp_speed/10%10);
				show_arg_cir(300,220,exp_speed%10);
				show_arg_cir(400,220,exp_quan/10%10);
				show_arg_cir(450,220,exp_quan%10);
				break;
			}
